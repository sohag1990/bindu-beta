...
func ControllerGenerator(args []string) {
	...
	f.WriteString("func Index" + args[1] + "() {\n")
	// Controller functionality here
	f.WriteString("}\n\n")

	// Get Single Data for Show
	f.WriteString("func Show" + args[1] + "() {\n")
	// Controller functionality here
	f.WriteString("}\n\n")

	// Post Single Data for New
	f.WriteString("func New" + args[1] + "() {\n")
	// Controller functionality here
	f.WriteString("}\n\n")

	// Create New Data for Update
	f.WriteString("func Update" + args[1] + "() {\n")
	// Controller functionality here
	f.WriteString("}\n\n")

	// Get Single Data for Destroy
	f.WriteString("func Destroy" + args[1] + "() {\n")
	// Controller functionality here
	f.WriteString("}\n\n")
